      ...
      <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
        <Reveal>
          <div className="relative">
            <img
              ...
              height={1024}
              loading="lazy"
              className="aspect-[4/3] w-full rounded-2xl border border-border object-cover shadow-[var(--shadow-card)]"
            />
        ...
        <Reveal delay={0.1}>
          ...
          <p className="mt-5 text-base leading-relaxed text-muted-foreground sm:text-lg">
            We help students, professionals, and families navigate complex visa and immigration
            pathways. Our team of licensed consultants combines deep expertise with a personal,
            transparent approach — so you always know exactly where your application stands.
          </p>
